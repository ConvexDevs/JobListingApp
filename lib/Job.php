...
class Job
{
    ...
    public function getJobByCategory($category)
    {
        $this->db->query("SELECT jobs.*,categories.name AS category_name 
                        FROM jobs INNER JOIN categories ON jobs.category_id=categories.id 
                        WHERE jobs.category_id=$category ORDER BY post_date asc");
        $result = $this->db->resultSet();
        return $result;
    }
    ...
    public function create($data)
    {
        ...
        contact_user,contact_email)VALUES(:category_id,:company,:job_title,:description,
        :salary,:location,:contact_user,:contact_email)");
